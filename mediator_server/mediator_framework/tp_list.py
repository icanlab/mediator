...
from mediator_server.yang_bindings.src_yang_bindings import ietf_l3vpn_ntw_binding, \
    ietf_network_instance_schema_mount_binding
from mediator_server.yang_bindings.target_yang_bindings import huawei_ifm_binding, huawei_bgp_binding, \
    huawei_network_instance_binding, huawei_network_instance_sm_binding, huawei_bgp_srv6_binding, \
    huawei_isiscomm_binding, huawei_segripv6_binding
...
from mediator_server.translation_scripts.src2target import _translate_ietf_routing_obj, _translate_ietf_routing_obj1, \
    _translate_ietf_routing_control_plane_protocol_obj, _translate_ietf_routing_bgp_obj
from mediator_server.translation_scripts.src2target import _translate_ietf_l3vpn_ntw_obj, \
    _translate_ietf_l3vpn_ntw_vpn_service_obj
...
from mediator_server.translation_scripts.target2src import _translate_huawei_network_instance_obj, \
    _translate_huawei_network_instance_obj1, _translate_huawei_network_instance_obj2
...
translate_yang_registry = {('HUAWEI', 'ROUTER6500', 'HUAWEIOS', '1.0.1111.2'):
    {
        ...
        _translate_ietf_interfaces_interface_obj, ietf_interfaces_binding, "yc_interfaces_ietf_interfaces__interfaces"),
        '/ietf-interfaces:interfaces/interface/ietf-ip:ipv4': (
        _translate_ietf_interfaces_interface_ipv4_obj, ietf_interfaces_binding,
        "yc_interface_ietf_interfaces__interfaces_interface"),
        ...
        # ietf-network-instance scripts(schema_mount)
        ...
        # (non)schema-mount script --> huawei
    ...
    ('HUAWEI', 'ROUTER6501', 'HUAWEIOS', '1.0.1111.2'): {
        # ietf 105 script
        '/ietf-routing:routing': (_translate_ietf_routing_obj_105, ietf_105_binding, "ietf_routing"),
        '/ietf-routing:routing/control-plane-protocols/control-plane-protocol': (_translate_ietf_routing_obj_105, ietf_105_binding, "yc_control_plane_protocols_ietf_routing__routing_control_plane_protocols"),
        # huawei 105 scripts
