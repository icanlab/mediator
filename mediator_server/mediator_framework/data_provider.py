...
def get_controller_configuration(neid, xpath, ns):
    ...
    # root = None
    # if 'interfaces' == name:
    #     with open('mediator_server/test/controller_current_configuration/ietf_interfaces_cc.xml', 'r') as f:
    #         parse = etree.XMLParser(remove_blank_text=True)
    #         root = etree.parse(f, parse)
    # elif 'routing' == name:
    #     with open('mediator_server/test/controller_current_configuration/ietf_routing_cc.xml', 'r') as f:
    #         parse = etree.XMLParser(remove_blank_text=True)
    #         root = etree.parse(f, parse)
    # elif 'l3vpn-ntw' == name:
    #     with open('mediator_server/test/controller_current_configuration/ietf_l3vpn_ntw_cc.xml', 'r') as f:
    #         parse = etree.XMLParser(remove_blank_text=True)
    #         root = etree.parse(f, parse)
...
def get_device_configuration(neid, xpath, ns):
    ...
    # root = None
    # if 'ifm' == name:
    #     with open('mediator_server/test/device_current_configuration/huawei_ifm_cc.xml', 'r') as f:
    #         parse = etree.XMLParser(remove_blank_text=True)
    #         root = etree.parse(f, parse)
    # elif 'bgp' == name:
    #     with open('mediator_server/test/device_current_configuration/huawei_bgp_cc.xml', 'r') as f:
    #         parse = etree.XMLParser(remove_blank_text=True)
    #         root = etree.parse(f, parse)
    # elif 'network-instance' == name:
    #     with open('mediator_server/test/device_current_configuration/huawei_network_instance_cc.xml', 'r') as f:
    #         parse = etree.XMLParser(remove_blank_text=True)
    #         root = etree.parse(f, parse)
