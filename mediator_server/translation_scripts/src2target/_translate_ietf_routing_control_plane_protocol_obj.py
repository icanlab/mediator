...
def _translate__control_plane_protocols(input_yang_obj, translated_yang_obj=None, xpath=None):
    """
    Translate method. This can only be called after object pointing to "self" is instantiated.
    ...
    Keys are already added as part of yang list instance creation
    """
    print("routing control plane protocol script")
    trans_yang_list = []

    # huawei_bgp
    translated_yang_obj = huawei_bgp()
    for k, listInst in input_yang_obj.control_plane_protocol.iteritems():
        _translate__routing_control_plane_protocols_control_plane_protocol(listInst, translated_yang_obj)
        xpath = "/a:bgp"
    ...
    for k, listInst in input_yang_obj.control_plane_protocol.iteritems():
        _translate__routing_control_plane_protocols_control_plane_protocol(listInst, translated_yang_obj1)
