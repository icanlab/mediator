...
from mediator_server.yang_bindings.target_yang_bindings.huawei_network_instance_sm_binding import yc_instance_huawei_network_instance__network_instance_instances_instance
...
def _translate__routing_control_plane_protocols_control_plane_protocol_ospf_areas_area_interfaces_interface(input_yang_obj: yc_interface_ietf_routing__routing_control_plane_protocols_control_plane_protocol_ospf_areas_area_interfaces_interface, translated_yang_obj=None):
  """
...
def _translate__routing_control_plane_protocols_control_plane_protocol_ospf_areas_area_interfaces(input_yang_obj: yc_interfaces_ietf_routing__routing_control_plane_protocols_control_plane_protocol_ospf_areas_area_interfaces, translated_yang_obj=None):
  """
  Translate method. This can only be called after object pointing to "self" is instantiated.
...
def _translate__routing_control_plane_protocols_control_plane_protocol_ospf_areas_area(input_yang_obj: yc_area_ietf_routing__routing_control_plane_protocols_control_plane_protocol_ospf_areas_area, translated_yang_obj=None):
  """
  Translate method. This can only be called after object pointing to "self" is instantiated.
  ...
  innerobj = _translate__routing_control_plane_protocols_control_plane_protocol_ospf_areas_area_interfaces(input_yang_obj.interfaces, translated_yang_obj)

  return translated_yang_obj

def _translate__routing_control_plane_protocols_control_plane_protocol_ospf_areas(input_yang_obj: yc_areas_ietf_routing__routing_control_plane_protocols_control_plane_protocol_ospf_areas, translated_yang_obj=None):
  """
  Translate method. This can only be called after object pointing to "self" is instantiated.
  ...
  for k, listInst in input_yang_obj.area.iteritems():
    ...
    innerobj = _translate__routing_control_plane_protocols_control_plane_protocol_ospf_areas_area(listInst, area_obj)
  return translated_yang_obj

def _translate__routing_control_plane_protocols_control_plane_protocol_ospf(input_yang_obj: yc_ospf_ietf_routing__routing_control_plane_protocols_control_plane_protocol_ospf, translated_yang_obj=None):
    """
    Translate method. This can only be called after object pointing to "self" is instantiated.
    ...
    innerobj = _translate__routing_control_plane_protocols_control_plane_protocol_ospf_areas(input_yang_obj.areas, translated_yang_obj)

    return translated_yang_obj

def _translate__control_plane_protocol(input_yang_obj: yc_ospf_ietf_routing__routing_control_plane_protocols_control_plane_protocol_ospf, translated_yang_obj=None, xpath=None):
    print("call as single script!")
    xpath = "/a:network-instance/a:instances/a:instance/b:ospfv2"
    ns_map = {'a': 'urn:huawei:yang:huawei-network-instance', 'b': 'urn:huawei:yang:huawei-ospfv2'}
    target_xpath = XPATH(xpath, ns_map)
    translated_yang_obj = yc_instance_huawei_network_instance__network_instance_instances_instance()

    site_obj = translated_yang_obj.ospfv2.sites.site.add("1")

    innerobj = _translate__routing_control_plane_protocols_control_plane_protocol_ospf_areas(input_yang_obj.ospf.areas, site_obj)
