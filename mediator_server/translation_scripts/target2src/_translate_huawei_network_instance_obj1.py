...
def _translate__network_instance_instances_instance_afs_af(input_yang_obj, translated_yang_obj=None):
    ...
    if input_yang_obj.route_distinguisher._changed():
        translated_yang_obj.rd = input_yang_obj.route_distinguisher
...
def _translate__network_instance_instances_instance_bgp_base_process_peers_peer(input_yang_obj, translated_yang_obj=None):
    ...
    if input_yang_obj.remote_as._changed():
        translated_yang_obj.bgp.peer_autonomous_system = input_yang_obj.remote_as
...
def _translate__network_instance_instances_instance_bgp_base_process_peers(input_yang_obj, translated_yang_obj=None):
    ...
    for k, listInst in input_yang_obj.peer.iteritems():
        routing_protocol_obj = translated_yang_obj.routing_protocols.routing_protocol.add("1")
        routing_protocol_obj.bgp.neighbor = k
        innerobj = _translate__network_instance_instances_instance_bgp_base_process_peers_peer(listInst, routing_protocol_obj)
...
def _translate__network_instance_instances_instance_bgp_base_process(input_yang_obj, translated_yang_obj=None):
    ...
    vpn_network_instance_obj = translated_yang_obj.vpn_network_accesses.vpn_network_access.add("1")
    innerobj = _translate__network_instance_instances_instance_bgp_base_process_afs(input_yang_obj.afs, vpn_network_instance_obj)
    ...
    innerobj = _translate__network_instance_instances_instance_bgp_base_process_peers(input_yang_obj.peers, vpn_network_instance_obj)
...
def _translate__network_instance_instances(input_yang_obj, translated_yang_obj=None):
    ...
    for k, listInst in input_yang_obj.instance.iteritems():
        ...
        vpn_service_obj.customer_name = k
        vpn_node_obj = vpn_service_obj.vpn_nodes.vpn_node.add("44")
        innerobj = _translate__network_instance_instances_instance(listInst, vpn_node_obj)
