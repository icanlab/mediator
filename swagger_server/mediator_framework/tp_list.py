...
translate_yang_registry = {('HUAWEI', 'ROUTER6500', 'HUAWEIOS', '1.0.1111.2'):
                               {'/ietf-interfaces:interfaces': (_translate_ietf_interfaces_obj, ietf_interfaces_binding, "ietf_interfaces"),
                                ...
                                '/ietf_l3vpn_ntw:l3vpn-ntw': (_translate_ietf_l3vpn_ntw_obj, ietf_l3vpn_ntw_binding, "ietf_l3vpn_ntw"),
                                '/huawei_ifm:ifm': (_translate_huawei_ifm_obj, huawei_ifm_binding, "huawei_ifm")}
                           }
